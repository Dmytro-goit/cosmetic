...
const Hero = () => {
  ...
  return (
    ...
    >
      <article
        className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py20 flex flex-col-reverse lg:flex-row 
      ...
      >
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          <hgroup data-aos="fade-up" data-aos-delay="500">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-8 max-w-lg mx-auto lg:mx-0">
              ...
              quos nesciunt iste ullam commodi! Modi quas suscipit labore
              nesciunt. Voluptatem ad sapiente ratione aliquam! Maiores fugit
              eaque molestiae aperiam est!
            </p>
          </hgroup>
          <nav
            data-aos="fade-up"
            data-aos-delay="600"
            className=" flex flex-col sm:flex-row gap-4 justify-center lg:justify-start gap-4 mb-8"
          >
            <a
              href="#appointment"
        ...
        >
          <div className="relative w-full max-w-md">
            ...
            ></span>
            <span
              className="bg-pink-400 rounded-full w-64 h-64 absolute -bottom-10 -right-10 opacity-20 "
              aria-hidden="true"
            ></span>
            <img
              src={hero}
