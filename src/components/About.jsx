  ...
  const approachItems = [
    {
      ...
      text: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, rem. Pariatur suscipit expedita",
    },
    {
          ...
          <div data-aos="fade-up" data-aos-delay="600" className="lg:w-7/12">
            <header>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                Sapiente maiores doloribus, minus nulla esse velit neque laborum
                tenetur ipsam eos tempore cumque ipsum. Reiciendis eligendi
                quaerat sunt ipsum molestiae temporibus!
              </p>
            </header>
        ...
        <aside className=" mt-20 bg-white rounded-2xl p-8 md:p-12 shadow-lg relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <blockquote className="text-lg text-gray-700 mb-6">
              " Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Dolores quae cupiditate quisquam, exercitationem veniam officia
              deleniti adipisci. Ratione nam quos, sunt nulla aperiam eligendi
              fuga tempora pariatur. Repudiandae, eaque minus! "
            </blockquote>
